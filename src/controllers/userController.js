...
const getUserData = async function (req, res) {
  ...
  res.status(200).send({ status: true, data: userDetails });
    ...
    console.lof("dint try to acess other's account")
...
// }
// const deletePostMessage = async function (req, res) {
//   let message = req.body.message
//   let user = await userModel.findById(req.params.userId)
//     if(!user) return res.send({status: false, msg: 'No such user exists'})
...
//     let updatedPosts = user.posts
//     //add the message to user's posts
//     updatedPosts.pop(message)
//     let deletedUser = await userModel.findOneAndDelete({_id: user._id},{posts: updatedPosts}, {new: true})
...
// module.exports.deleteUser = deleteUser
// module.exports.deletePostMessage = deletePostMessage
